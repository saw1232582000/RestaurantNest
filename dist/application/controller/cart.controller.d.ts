...
export declare class CartController {
    ...
    addToCart(product: AddToCartRequestSchema, req: any): Promise<CoreApiResonseSchema<{
        message: string;
    }>>;
    removeFromCart(product: RemoveFromCartRequestSchema, req: any): Promise<CoreApiResonseSchema<{
        message: string;
    }>>;
}
